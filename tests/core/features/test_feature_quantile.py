...
# Test quantile calculation for an empty series
def test_calculate_quantile_empty_series():
...
def test_calculate_quantile_all_identical_values():
    ...
    expected = 3.0  # Any quantile of identical values is the value itself
    result = calculate_quantile(data)
    assert result == expected, f"Expected {expected}, but got {result}."
...
def test_calculate_quantile_large_numbers():
    ...
    expected = 3e10  # Median (50th percentile)
    result = calculate_quantile(data)
    assert result == expected, f"Expected {expected}, but got {result}."
...
def test_calculate_quantile_small_numbers():
    ...
    expected = 3e-10  # Median (50th percentile)
    result = calculate_quantile(data)
